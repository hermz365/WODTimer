...
namespace WinRTXamlToolkit.Controls
{
    ...
    public sealed class NumericUpDown : RangeBase
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            {
                _decrementButton.Tapped += OnDecrementButtonTapped;
                var pcc =
            ...
            {
                _incrementButton.Tapped += OnIncrementButtonTapped;
                var pcc =
                    new PropertyChangeEventSource<bool>
        ...
        private void OnDecrementButtonTapped(object sender, TappedRoutedEventArgs e)
        {
            e.Handled = true;
            this.Decrement();
        }

        private void OnIncrementButtonTapped(object sender, TappedRoutedEventArgs e)
        {
            e.Handled = true;
            this.Increment();
        }
